...
func allocOutputBufferPool(with inputDescription:CMFormatDescription, outputRetainedBufferCountHint: Int) -> (bufferPool:CVPixelBufferPool?,
    colorSpace:CGColorSpace?,
    outputDescription:CMFormatDescription?) {
